...
async def home_callback_handler(bot, query):
    ...
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 Updates", url="https://t.me/Discussion_Maniaac"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/Rename_Support")],
                    [InlineKeyboardButton("🛠️ Help", callback_data='help'),
		            InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                    [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/YetGood")]
		  ])
